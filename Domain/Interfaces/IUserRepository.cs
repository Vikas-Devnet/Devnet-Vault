...
public interface IUserRepository
{
    ...
    Task<UserMaster?> AddAsync(UserMaster user, UserKey userkey, CancellationToken ctx = default);
    ...
    Task<bool> UpdatePassword(UserKey userKey,Guid userId, string password, string ipAddress, CancellationToken ctx = default);
